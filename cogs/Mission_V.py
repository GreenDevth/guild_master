                ...
                if check == 1 and mission_check == 1:  # Check for already mission exists.
                    if channel == 0 or channel_id is None:  # Check for channel or channel id exists.
                        ...
                        await channel_send.send(
                            ...
                            '\nที่โรงนาชั้น 2 ให้ผู้เล่นนำสินค้าใส่ไว้ในตู้ ตั้งชื่อ และล็อคกุญแจ '
                            '\nให้เรียบร้อย หลักงจากนั้นให้ถ่ายภาพสินค้าข้างในตู้และ กดปุ่ม'
                            '\nSEND MISSION เพื่ออัพโหลดภาพสินค้าและส่งให้แอดมิน'
