...
class MissionF(commands.Cog):
    ...
    async def on_ready(self):
        print('Mission Fishing online')

    @commands.command(name='mission_f')
    async def mission_f_command(self, ctx):
        await ctx.send(
            '**🐟 ภารกิจนำส่งปลา** '
        ...
        await ctx.send(
            ...
            components=[
                [
                    ...
                    Button(style=ButtonStyle.blue, label='REPORT MISSION', emoji='📩', custom_id='mission_f_report'),
    ...
    async def on_button_click(self, interaction):
        ...
        f_btn = interaction.component.custom_id
